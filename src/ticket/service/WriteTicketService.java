...
public class WriteTicketService {
	...
	public void regist(RegistRequest registReq) throws ParseException {
		...
		try {
			...
			ticketDao.insert(conn,
					new Ticket(Integer.parseInt(registReq.getTno()), registReq.getCarno(), registReq.getPhone(),
							registReq.getGrade(), registReq.getTstat(), dateFormat(registReq.getStartDate()),
